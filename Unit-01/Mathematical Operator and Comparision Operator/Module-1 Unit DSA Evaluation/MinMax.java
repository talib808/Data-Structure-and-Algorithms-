...
[5,3,1,2,5,1,2]: The sixth element is a local minima because 1 is less than 5 and 2.
The minimum distance is between the fifth and the sixth element. minDistance = 6 - 5 = 1.
The maximum distance is between the third and the sixth element. maxDistance = 6 - 3 = 3.
For the third test case

There are two critical points:

[1,3,2,2,3,2,2,2,7]: The second element is a local maxima because 3 is greater than 1 and 2.
[1,3,2,2,3,2,2,2,7]: The fifth element is a local maxima because 3 is greater than 2 and 2.
Both the minimum and maximum distances are between the second and the fifth element.Thus, minDistance and maxDistance is 5 - 2 = 3.
Note that the last element is not considered a local maxima because it does not have a next element.*/
