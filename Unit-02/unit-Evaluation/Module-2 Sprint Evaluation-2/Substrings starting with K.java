...
In the given sample test case, the given string A = "aman". 
The total number of substrings of the string A, are ->[a, am, ama, aman, m, ma, man, a, an, n]. The given character K is 'a'.
The total number of substrings starting with a are 6, which are {a,am,ama,aman,a,an}. Therefore, the required output is 6.
*/
import java.util.*;
class Main{
